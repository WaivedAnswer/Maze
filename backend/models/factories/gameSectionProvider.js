...
const { getRotatedCoord, getRotatedWallCoord } = require('../rotations')
...
class GameSectionProvider {
    ...
    createConnection(sectionDirection, direction ) {
        ...
        return new Connection(direction, getRotatedCoord(sectionDirection, beforeRotation, this.sectionDimensions), this.sectionDimensions)
    }
